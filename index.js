...
async function init() {
    ...
    // Enable collapsible drawer - use setTimeout to ensure DOM is ready
    setTimeout(function() {
        $('#ragfordummies_container .inline-drawer-toggle').off('click').on('click', function() {
            const icon = $(this).find('.inline-drawer-icon');
            const content = $('#ragfordummies_container .inline-drawer-content');
            
            console.log('[' + MODULE_NAME + '] Dropdown clicked, content found:', content.length);
