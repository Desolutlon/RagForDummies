...
const INJECTION_DEBOUNCE_MS = 500; // Minimum time between injections
...
async function init() {
    ...
    if (eventSourceToUse) {
        ...
        // Register multiple generation events - try all of them
        ...
        generationEvents.forEach(function(eventName) {
            eventSourceToUse.on(eventName, function(data) {
                console.log('[' + MODULE_NAME + '] ==========================================');
                console.log('[' + MODULE_NAME + '] 🎯 EVENT FIRED: ' + eventName);
                console.log('[' + MODULE_NAME + '] ==========================================');
                injectContextBeforeGeneration(data);
            });
            console.log('[' + MODULE_NAME + '] Registered handler for: ' + eventName);
        });
        
        console.log('[' + MODULE_NAME + '] Registered listeners for: ' + generationEvents.join(', '));
