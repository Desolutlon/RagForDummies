...
async function init() {
    ...
    if (typeof eventSource !== 'undefined') {
        ...
        // Only register essential events, not all variants
        ...
        console.log('[' + MODULE_NAME + '] Registered essential event listeners');
    } else {
    ...
    if (typeof eventSource === 'undefined') {
        ...
        // Only start polling if auto-index is enabled
